...
namespace ZinzinDuCretace
{
    ...
    public class BonusInvincible : Projectiles
    {
        /// <summary>
        /// le jeu
        /// </summary>
        ...
        /// <summary>
        /// Constructeur de Bonus d'invincibilite
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="g"></param>
        /// <author>Laszlo</author>
        public BonusInvincible(double x, double y, LeJeu g) : base(x, y, g, "bonusInvincible/bonusInvincible.png")
        {
            jeu = g;
        ...
        /// <summary>
        /// nom de l'objet "bonusInvincible"
        /// </summary>
        public override string TypeName => "bonusInvincible";
